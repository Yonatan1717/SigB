\noindent \textbf{Lenke til all kode og alle plotter for innleveringen finnes i Vedlegg A.}

\hypertarget{innlevering3}{}
\section*{Innlevering 3}
\addcontentsline{toc}{section}{Innlevering 3}
...
amplitude og en faseforskyvning på $180^\circ$.
...
\end{figure}
Det opprinnelige pulstoget, Fourier-serien før filteret og
...
\end{figure}
Det filtrerte signalet har betydelig rundere flanker enn
...
flanker.\\[1em]
Antallet Fourier-komponenter $N$ bestemmer samtidig hvor stor
båndbredde som finnes i signalet før filtrering. Et større $N$
