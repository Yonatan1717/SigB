\noindent \textbf{Lenke til all kode og alle plotter for innleveringen finnes i Vedlegg A.}\\[1em]
Min besvarelse følger følgende mønster: 
\[
   \text{tidsdomenet } \rightarrow \text{ fourierrekke } \rightarrow \text{ filter } \rightarrow \text{ tidsdommenet}
\]
