...
%% Oppgave g) - Parameterstudie

% Parameterne N og f_cut øverst i scriptet kan endres for å undersøke
% hvordan antall Fourier-komponenter og filterets knekkfrekvens påvirker
% signalet. Eksempelverdier som kan testes:
%
%   N = 6, 20, 100, 500
%   f_cut = 100, 250, 500, 1000, 5000 Hz
%
% Kjør scriptet på nytt etter at parameterne er endret.
